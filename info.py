...
API_ID = int(environ.get('API_ID', '10660564')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '527e6297989f4e7cda5091f5bf41d0e4')  # API Hash from my.telegram.org
...
PICS = (environ.get('PICS', 'https://unitedcamps.in/Images/IMG_1741018796.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://unitedcamps.in/Images/IMG_1741018796.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://unitedcamps.in/Images/IMG_1741018796.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://unitedcamps.in/Images/IMG_1741018796.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://unitedcamps.in/Images/IMG_1741018796.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://unitedcamps.in/Images/IMG_1741018796.jpg')).split()  # Fsub pic
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002239624090'))  # Premium logs channel id
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002386857422")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002386857422")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/4nT0x43P/Img2url-bot.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'dezisingh@okicici')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ramjikijay809:obEA3UlL5lomV4w8@cluster0.tbhw1yz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002816348036'))  # Notification of sent to your channel
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/EZ_Request_Grp') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/PRESIDENTIND7') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/Radha_Rani_Backup') # Update channel link for the bot
